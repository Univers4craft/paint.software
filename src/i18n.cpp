...
const QHash<QString, QString> &table() {
    static const QHash<QString, QString> m = {
        ...
        {"Importer un calque depuis un fichier", "Import Layer from File"},
        {"Retourner le calque", "Flip Layer"},
        {"Rotation / Zoom du calque...", "Rotate / Zoom Layer..."},
        {"Rotation / Zoom du calque", "Rotate / Zoom Layer"},
        {"Angle : ", "Angle: "},
        {"Angle : 0°", "Angle: 0°"},
        {"Échelle : ", "Scale: "},
        {"Échelle : 100 %", "Scale: 100 %"},
        {"Images (*.png *.jpg *.jpeg *.bmp *.gif *.tiff *.webp)", "Images (*.png *.jpg *.jpeg *.bmp *.gif *.tiff *.webp)"},
        ...
        {"Pression", "Pressure"},
        {"Sensibilité à la pression du stylet (varie la taille du point)",
         "Stylus pressure sensitivity (varies dab size)"},
        ...
        {"Heptagone", "Heptagon"},
        {"Octogone", "Octagon"},
        {"Étoile à 3 branches", "3-Point Star"},
        {"Étoile à 4 branches", "4-Point Star"},
        {"Étoile à 5 branches", "5-Point Star"},
        {"Étoile à 6 branches", "6-Point Star"},
        {"Flèche", "Arrow"},
        {"Chevron", "Chevron"},
        {"Bulle de dialogue", "Speech Balloon"},
        {"Nuage", "Cloud"},
        {"Cœur", "Heart"},
        {"Éclair", "Lightning"},
        {"Croix", "Cross"},
        {"Coche", "Check Mark"},
        {"Linéaire", "Linear"},
        {"Linéaire réfléchi", "Linear (Reflected)"},
        {"Radial", "Radial"},
        {"Conique", "Conical"},
        {"Spirale", "Spiral"},
        {"Répétition :", "Repeat:"},
        ...
        // Effect parameter labels (live-preview dialogs)
        {"Distance", "Distance"},
        {"Angle", "Angle"},
        {"Fragments", "Fragments"},
        ...
        {"Taille de mine", "Lead size"},
        {"Mode (0=Dilater, 1=Éroder)", "Mode (0=Dilate, 1=Erode)"},
